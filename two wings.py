...
def write_down(output_table, output_directory):
    global SCALE
    header = 'Photo\tScale\tA\tBL\tBR\tV\tG\tD\tE\tSex\tLX\tRX\n'
    hor, ver = [15, 19, 27, 35], [11, 23, 31]
    for a in output_table[1:]:
        ...
        header += a[0]+'\t'
        row_scale = math.sqrt((a[7] - a[9]) ** 2 + (a[8] - a[10]) ** 2); header += str(row_scale) + '\t'  # scale
        for c in range(11, 39, 4):
...
table = [['Photo', 'Screen width', 'Screen height',
          ...
          'SP1R', 'SP1C', 'SP2R', 'SP2C',
          'AAR', 'AAC', 'APR', 'APC',
          'BLLR', 'BLLC', 'BLRR', 'BLRC', 'BRLR', 'BRLC', 'BRRR', 'BRRC',
          'VAR', 'VAC', 'VPR', 'VPC',
          'GLR', 'GLC', 'GRR', 'GRC',
          'DAR', 'DAC', 'DPR', 'DPC',
          'ELR', 'ELC', 'ERR', 'ERC', 'Sex', 'LX', 'RX\n']]
...
while True:
    try:
        directory = r'' + input('Folder with your images:')
...
while True:
    ...
    if break_var is True:
        ...
        while True:  # HERE
            ...
            sign = {9: str(SCALE) + ' mm SCALE', 13: 'A', 17: 'BL', 21: 'BR', 25: 'V', 29: 'G', 33: 'D', 37: 'E'}
            color = [(255, 127, 0), (0, 0, 255), (0, 255, 0), (255, 0, 0)]
            color_dict = {7: 0, 9: 0, 11: 1, 13: 1, 15: 1, 17: 1, 19: 1, 21: 1,
                          23: 2, 25: 2, 27: 2, 29: 2, 31: 3, 33: 3, 35: 3, 37: 3}
            ...
            if Pressed in measureActionKeys:
                if Pressed == ord('q') or Pressed == ord('Q'):
                    ...
                    if order < 16:
                        ...
                        appendage = [None, None, None]
                        sex = input('beetle\'s sex:')
                        quantity_left = input('left_trait_quantity:')
                        quantity_right = input('right_trait_quantity:')
                        table_row += [sex, quantity_left, quantity_right + '\n']
                        ...
                        Pressed = None
                elif 2 <= order <= 16 and order % 2 == 0 and Pressed == ord('z') or Pressed == ord('Z'):
